...
namespace TeachingApp.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Text,Answer,Category")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Text,Answer,Category")] Question question)
        {
            if (ModelState.IsValid)
            {
